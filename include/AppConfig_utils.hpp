...
public:
    ...
    ConfigValue(std::shared_ptr<ConfigManager> config, const std::string &key_path, T default_value = T{})
        : config_(std::move(config)), key_path_(key_path), default_value_(default_value) {}

    ConfigValue(const ConfigValue &other)
        : config_(other.config_), key_path_(other.key_path_), default_value_(other.default_value_),
    ...
    ConfigValue(ConfigValue &&other) noexcept
        : config_(std::move(other.config_)), key_path_(std::move(other.key_path_)),
          default_value_(std::move(other.default_value_)), cached_value_(std::move(other.cached_value_)),
...
public:
    ...
    ConfigObject(std::shared_ptr<ConfigManager> config, const std::string &key_path, const T &default_value = T{})
        : config_(std::move(config)), key_path_(key_path), default_value_(default_value) {}
...
class ConfigUpdater {
public:
    void add_update(const std::string &key_path, const T &value) { updates_[key_path] = value; }
